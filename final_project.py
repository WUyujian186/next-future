#coding:gbk
"""
使用python编写程序，实现对《黎明破晓的街道》文本中人物关系的提取，并利用Gelphi软件对人物关系可视化，生成如下类似人物关系图谱。
作者：邬雨建
"""
...
jieba.load_userdict("roletable.txt")		#自己输入的角色表
with codecs.open("黎明破晓的街道.txt", "r", "ansi") as f:
...
with codecs.open("name.txt", "w", "gbk") as f:
	f.write("Id Label Weight\r\n")		#生成一个txt格式的节点文件
	for name, times in names.items():
		f.write(name + " " + name + " " + str(times) + "\r\n")
with codecs.open("relationship.txt", "w", "gbk") as f:
